...
Set-Location "C:\Users\Roodmack\Desktop\Azure Function\Bicep\05 Azure World Practice\7.Bicep Keyvault Integration"
# Deploy to Dev
...
# Remove Resourve Group
$resourcegroupetodel=(Get-AzResourceGroup -Name '*azr-rg-bicep*')
$resourcegroupetodel | Remove-AzResourceGroup 